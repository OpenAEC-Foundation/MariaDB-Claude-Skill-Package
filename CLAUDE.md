...
**Mission**: Build a complete, production-ready skill package for MariaDB and publish it under the OpenAEC Foundation on GitHub. This is your standing order for every session in this workspace.
...
### Release:
```bash
git tag -a v1.0.0 -m "v1.0.0: X deterministic skills for MariaDB"
git push origin v1.0.0
gh release create v1.0.0 --title "v1.0.0 — MariaDB Skill Package" \
